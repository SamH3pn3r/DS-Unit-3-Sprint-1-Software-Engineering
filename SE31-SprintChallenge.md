...
Answer 1: Using python writing conventions and writing helpful comments

Answer 2: It helps us save time and our sanity. With containers, we are 
able to reuse code instead of rewriting the same thing for the nth time.
